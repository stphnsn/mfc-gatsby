...
const Page = () => (
  <Template
    title="Privacy policy | Manor Farm Cottage, Goodmanham, East Yorkshire"
    desc="Boutique rural holiday cottage in Goodmanham, East Yorkshire. Close to York, Beverley and Hull"
    id="privacy-policy">
    <section className="intro">
      <h1>Privacy policy</h1>
      <p>
        This privacy policy sets out how Manor Farm Cottages uses and protects any information that you give Manor Farm
        Cottages when you use this website.
      </p>
    </section>

    <section className="text">
      <p>
        Manor Farm Cottages is committed to ensuring that your privacy is protected. Should we ask you to provide
        certain information by which you can be identified when using this website, then you can be assured that it will
        only be used in accordance with this privacy statement.
      </p>
      <p>
        Manor Farm Cottages may change this policy from time to time by updating this page. You should check this page
        from time to time to ensure that you are happy with any changes. This policy is effective from 1st January 2011.
      </p>
    </section>
    ...
    <section className="text">
      ...
      <ul>
        ...
        <li>
          ...
          contact you by email, phone, fax or mail. We may use the information to customise the website according to
          your interests.
        </li>
      </ul>
    </section>
